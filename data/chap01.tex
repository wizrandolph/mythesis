...
为了解决这些问题，在2018年，杜孟艳等人创新性地发展了基于FRET效率（$E_D$）和受供体浓度比（$R_C$）线性分离的FRET双杂交分析方法，简称为 Du-Chen-FRET（DC-FRET）\upcite{Du2018}。
...
U-Net 模型是图像分割领域广泛运用的卷积神经网络架构，它能够有效捕捉荧光图像的特征，精准地提取 ROIs 的荧光强度信息\upcite{ronneberger2015u}。
